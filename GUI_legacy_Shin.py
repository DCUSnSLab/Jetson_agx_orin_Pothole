...
class MyMainWindow(QWidget):
    ...
    def click_start(self):
        ...
        command = ["python3", "/home/snslab/jetson-inference/build/aarch64/bin/Pothole/GUI_tool_for_execute_scripts/scripts/segnet-camera_NoGps.py", "--network=fcn-resnet18-cityscapes-1024x512", f"--x_coord={str(self.roi_coord[0])}", f"--y_coord={str(self.roi_coord[1])}", f"--reversed={str(self.is_it_reversed)}"]
